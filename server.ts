...
import LoginWithOtpController from "./src/controller/LoginWithOtp"
...
app.use('/resetPassword', VerifyToken,resetPasswordController)
...
app.use('/LoginWithOtp',LoginWithOtpController)
